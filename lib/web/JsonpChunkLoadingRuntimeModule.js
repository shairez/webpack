...
class JsonpChunkLoadingRuntimeModule extends RuntimeModule {
	...
	generate() {
		...
		return Template.asString([
			...
			withHmr
				? Template.asString([
						"var currentHmrUpdate;",
						"var currentHmrUpdatedModules;",
						"var waitingHmrUpdateResolves",
						...
						Template.indent([
							...
							Template.indent([
								...
								Template.indent([
									"currentHmrUpdate[moduleId] = moreModules[moduleId];",
									"currentHmrUpdatedModules.push(moduleId);"
								]),
								"}"
							]),
							"}",
							"if(waitingHmrUpdateResolves[chunkId]) {",
							Template.indent([
								"waitingHmrUpdateResolves[chunkId]();",
								"waitingHmrUpdateResolves[chunkId] = undefined;"
							]),
							"}"
						]),
						"};",
						...
						`${
							RuntimeGlobals.hmrDownloadUpdateHandlers
						}.jsonp = function(update, promises, applyHandlers, updatedModules) {`,
						Template.indent([
							"currentHmrUpdate = {};",
							"currentHmrUpdatedModules = updatedModules;",
							...
							Template.indent(
								Template.getFunctionContent(
									...
									.replace(/\$updateModuleFactories\$/g, "currentHmrUpdate")
							...
							"});",
							"var head = document.getElementsByTagName('head')[0];",
							"return Promise.all(Object.keys(installedChunks).map(function(chunkId) {",
							Template.indent([
								'console.log("[HMR] downloading javascript update chunk " + chunkId);',
								"return new Promise(function(resolve, reject) {",
								Template.indent([
									"waitingHmrUpdateResolves[chunkId] = resolve;",
