...
/*global $options$ $updateModuleFactories$ $updateRuntimeModules$ $moduleCache$ $moduleFactories$ */
	...
	for (var j = 0; j < outdatedModules.length; j++) {
		...
		if (
			...
			outdatedSelfAcceptedModules.push({
				...
				require: $moduleCache$[outdatedModuleId].require,
				...
				if (
					...
					if (module) {
						...
						for (var i = 0; i < callbacks.length; i++) {
							try {
								callbacks[i].call(null, moduleOutdatedDependencies);
							} catch (err) {
